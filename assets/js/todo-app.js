    ...
    const html = `
           <li class="todo-item flex items-center gap-2 justify-between pt-[13px] mt-[13px] border-t border-light first:mt-0 first:pt-0 first:border-none"> 
                  <div class="flex items-center justify-center">                      
                    ...
                    <div class="max-w-[calc(138px_+_(650_-_138)_*_((100vw_-_320px)_/_(1920_-_320)))] edit-div">
                  ...
                  <div> 
                    <ul class="flex gap-3 todo-sublist">
                      <li class="cursor-pointer"> 
                        <div class="badge badge-xs px-3 font-semibold rounded-full bg-primary-extralight text-primary">${priority}</div>
                      </li>
                      <li class="cursor-pointer"> 
                        <div class="badge badge-xs px-3 font-semibold rounded-full bg-success-light text-success">${status}</div>
                      </li>
